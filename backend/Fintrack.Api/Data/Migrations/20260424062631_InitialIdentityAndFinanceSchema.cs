...
{
    /// <inheritdoc />
    public partial class InitialIdentityAndFinanceSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxIdentificationNumber = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    SalesAndServiceTaxNumber = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerRegistrationNumber = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    CustomerTaxIdentificationNumber = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxRate = table.Column<decimal>(type: "numeric(7,4)", precision: 7, scale: 4, nullable: false),
